...
import { Users, User, Sparkles, ArrowLeft, Loader2 } from "lucide-react";
  ...
  const openLobby = async () => {
    ...
    try {
      const r = await http.post("/rooms", {
        mode, topic: topic || "General knowledge", difficulty,
    ...
    <div className="min-h-[100svh] grid-bg px-6 py-10 flex flex-col items-center">
      <div className="w-full max-w-2xl">
        ...
        <div className="space-y-8">
          ...
          <div>
            <label className="text-xs uppercase tracking-[0.2em] font-bold text-white/50 block mb-3">Difficulty</label>
          ...
          <div>
            <label className="text-xs uppercase tracking-[0.2em] font-bold text-white/50 block mb-3">Questions</label>
          ...
          <div>
            <label className="text-xs uppercase tracking-[0.2em] font-bold text-white/50 block mb-3">Time per question</label>
            <div className="flex gap-3">
              {[10, 15, 20, 30].map((t) => (
